...
const Home = () => {
  return (
    <main className='min-h-[100vh] w-full bg-center bg-cover bg-[url("/src/assets/home/background-home-mobile.jpg")] sm:bg-[url("/src/assets/home/background-home-tablet.jpg")] lg:bg-[url("/src/assets/home/background-home-desktop.jpg")] pt-32 sm:pt-44 lg:pt-64 pb-12'>
